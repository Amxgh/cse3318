...
void merge(int array[], int left, int mid, int right) {
    ...
    */
    ...
    // might start from say, 10. In this case left would be 10; so, we use left
    // as an offset
    ...
    */
    ...
    Based on the above, we can tell that our array does not have 3,4 so we need
    to copy those over.
    ...
    */
    ...
    // In our example, we had elements remaining inside temp_left. However, it
    // is possible to have elements remaining inside temp_right. To fix that we
    // need to do the same for temp_right. NOTE: EITHER temp_left OR temp_right
    // will have elements remaining; NOT BOTH
